...
This project is a simple Statistics Calculator built using Test-Driven Development (TDD).  
...
console.log(
  StatsCalculator.calculateStats([2, 4, 21, -8, 53, 40])
);
